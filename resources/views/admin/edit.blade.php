...
@section('content')
    <div class="layout-2columns sidebar-left">
        <div class="column left">
            @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', 'user.edit', $object) @endphp
            @include('webed-users::admin._partials._profile-sidebar')
            @php do_action(BASE_ACTION_META_BOXES, 'bottom-sidebar', 'user.edit', $object) @endphp
        </div>
        <div class="column main">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs tab-change-url">
                    ...
                    @endif
                    @php do_action(BASE_ACTION_META_BOXES, 'user-tab-links', 'user.edit', $object) @endphp
                </ul>
                <div class="tab-content">
                    ...
                    @endif
                    @php do_action(BASE_ACTION_META_BOXES, 'user-tab-pane', 'user.edit', $object) @endphp
                </div>
            </div>
            @php do_action(BASE_ACTION_META_BOXES, 'main', 'user.edit', $object) @endphp
        </div>
    </div>
@endsection
